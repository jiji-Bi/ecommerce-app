    ...
    <header class="header-v3">
        ...
        <div class="container-menu-desktop trans-03">
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop p-l-45">
                    ...
                    <!-- Logo desktop -->
                    <a href="#" class="logo">
                        <img src="{{ asset('Client-assets/images/icons/chezjiji-blanc.png') }}"
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="index.html"><img src="{{ asset('CLient-assets/images/icons/logo-01.png') }}"
                        alt="IMG-LOGO"></a>
            </div>
        ...
        <div class="wrap-slick1 rs2-slick1">
            <div class="slick1">
                <div class="item-slick1 bg-overlay1"
                    ...
                    data-thumb="{{ asset('Client-assets/images/thumb-01.jpg') }}" data-caption="Women’s Wear">
                ...
                <div class="item-slick1 bg-overlay1"
                    ...
                    data-thumb="{{ asset('Client-assets/images/thumb-02.jpg') }}" data-caption="Men’s Wear">
                    <div class="container h-full">
                        <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
                ...
                <div class="item-slick1 bg-overlay1"
                    style="background-image: url('{{ asset('Client-assets/images/slide-07.jpg') }}');"
                    ...
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        <div class="row isotope-grid">
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0 label-new" data-label="New">
                                        <img src="{{ asset('Client-assets/images/product-01.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-02.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-03.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-04.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-05.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-06.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-07.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-08.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-09.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-10.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-11.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-12.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-13.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-14.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-15.jpg') }}"
                                            alt="IMG-PRODUCT">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        <img src="{{ asset('Client-assets/images/product-16.jpg') }}"
                                            alt="IMG-PRODUCT">
                                ...
                                <div class="slick3 gallery-lb">
                                    ...
                                    <div class="item-slick3"
                                        ...
                                        <div class="wrap-pic-w pos-relative">
                                            ...
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset('Client-assets/images/product-detail-02.jpg') }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
