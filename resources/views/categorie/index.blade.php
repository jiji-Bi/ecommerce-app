            ...
            <nav class="navbar navbar-light navbar-top navbar-expand">
                <div class="navbar-logo"><button class="btn navbar-toggler navbar-toggler-humburger-icon" type="button"
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img src="{{ asset('') }}" alt=""
                                    width="32">
                    ...
                    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
                                        ...
                                        <div class="row text-center align-items-center gx-0 gy-0">
                                            <div class="col-4"><a
                                                    ...
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/behance.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/google-cloud.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/slack.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/github.png') }}"
                                                        width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/bitbucket.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/google-drive.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/trello.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/figma.png') }}"
                                                        alt="" width="20">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/twitter.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/pinterest.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('Admin-assets/img/nav-icons/linkedin.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/google-maps.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/google-photos.png') }}"
                                                        alt="" width="30">
                                            ...
                                            <div class="col-4"><a
                                                    class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                    href="#!" target="_blank"><img
                                                        src="{{ asset('/Admin-assets/img/nav-icons/spotify.png') }}"
                                                        alt="" width="30">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link lh-1 px-0 ms-5" id="navbarDropdownUser"
                                ...
                                <div class="avatar avatar-l"><img class="rounded-circle"
                                        src="{{ asset('Admin-assets/img/team/57.png') }}" alt=""></div>
                            </a>
            ...
            <div class="content">
                <div class="pb-5">
                    <div class="row">
                      ...
                      <div class="mb-0"><label class="form-label" for="exampleTextarea">Example Textarea</label> <textarea class="form-control" id="exampleTextarea" rows="3"> </textarea></div>
