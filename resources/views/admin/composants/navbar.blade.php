                            ...
                            <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                                <div class="row text-center align-items-center gx-0 gy-0">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!" target="_blank"><img
                                                src="{{ asset('/Admin-assets/img/nav-icons/slack.png') }}" alt=""
                                                width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!" target="_blank"><img
                                                src="{{ asset('/Admin-assets/img/nav-icons/trello.png') }}" alt=""
                                                width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!" target="_blank"><img
                                                src="{{ asset('/Admin-assets/img/nav-icons/figma.png') }}" alt=""
                                                width="20">
                            ...
                            <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                                <div class="text-center pt-4 pb-3">
                                    <div class="avatar avatar-xl"><img class="rounded-circle"
                                            src="{{ asset('Admin-assets/img/team/57.png') }}" alt="">
                                    </div>
