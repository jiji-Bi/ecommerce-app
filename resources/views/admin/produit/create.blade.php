        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-header ">Ajouter vos produits
                    </h2>
                </div>
                <div class="card-body">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-details-tab" data-bs-toggle="pill" data-bs-target="#pills-details" type="button" role="tab" aria-controls="pills-details" aria-selected="true">Détails produit</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-image-tab" data-bs-toggle="pill" data-bs-target="#pills-image" type="button" role="tab" aria-controls="pills-image" aria-selected="false">Déclinaisons produit</button>
                        </li>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-details" role="tabpanel" aria-labelledby="pills-details-tab" tabindex="0">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" value="{{ @old('nom') }}" id="exampleFormControlInput1" type="text" placeholder="name@example.com" name="nom">
                                    @error('nom')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="categorie" class="form-select form-select-sm" aria-label="form-select-sm example">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" value="{{ @old('stock') }}" id="exampleFormControlInput1" type="number" placeholder="name@example.com" name="stock">
                                    @error('stock')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" value="{{ @old('price') }}" id="exampleFormControlInput1" type="number" step="0.01" placeholder="name@example.com" name="price">
                                    @error('price')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                        ...
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                ...
                                                <table class="table table-bordered" id="dynamicAddRemove">
                                                    ...
                                                    <tr>
                                                        <td><input type="text" name="moreFields[0][nom]" placeholder="Enter title" class="form-control" />
                                                            @error('nom')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </td>
                                                        <td><input type="number" step="0.01" name="moreFields[0][price]" placeholder="Enter title" class="form-control" />
                                                            @error('price')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </td>
                                                        <td><input type="number" name="moreFields[0][quantity]" placeholder="Enter title" class="form-control" />
                                                        ...
                                                        <td>
                                                            <input class="form-control" id="exampleFormControlInput1" multiple type="file" placeholder="name@example.com" name="images[]">
                                                        </td>
                                                        <td><button type="button" name="add" id="add-btn" class="btn btn-primary">Add More</button>
                                                        </td>
                                                    </tr>
                                                </table>
...
<script type="text/javascript">
    ...
    $("#add-btn").click(function() {
        ...
        html +=
            ...
            '][nom]" placeholder="Enter your Name" class="form-control" /></td>';
        html +=
            '<td><input type="text" name="moreFields[' + i +
            '][quantity]" placeholder="Enter your Name" class="form-control" /></td>';
        html +=
            '<td><input type="text" name="moreFields[' + i +
            '][price]" placeholder="Enter your Name" class="form-control" /></td>';
        ...
        html +=
        '<td><input multiple type="file" class="form-control" id="exampleFormControlInput1" name = "images[]"></td>';
        html +=
